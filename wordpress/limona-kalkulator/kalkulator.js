...
function calculateBelow(input) {
  var comm = (input.commissionPct || 0) / 100;
  var rw = input.valuePerSqm * 0.9;
  var offer30 = rw * 0.7;
  var pcc = (offer30 + input.totalDebt) * 0.02;
  var costs = offer30 + (offer30 * comm) + pcc + input.notaryFee;
  ...
  if (input.manualOffer != null && input.manualOffer > 0) {
    ...
    var pcc2 = mo * 0.02;
    var nf2 = 1000;
    var costs2 = mo + (mo * comm) + pcc2 + nf2;
    var inv2 = costs2;
    var profit2 = rw - inv2;
...
function calculateAbove(input) {
  ...
  if (input.manualOffer != null && input.manualOffer > 0) {
    ...
    var mpcc = mo * 0.02;
    var mc = mo + (mo * comm) + mpcc + input.notaryFee;
...
function PctInput(props) {
  ...
  var display = focused.current ? raw : (props.value ? String(props.value) : "");
  ...
  return e("div", null,
    ...
    e("input", {
      ...
      inputMode: "decimal",
      value: display,
      placeholder: props.placeholder || "2.46",
      onFocus: function() {
        focused.current = true;
        setRaw(props.value ? String(props.value) : "");
      },
  ...
  return e("div", null,
    e("div", null,
      ...
      e("div", { className: "lk-grid lk-grid-2" },
        ...
        e(PctInput, { label: "Prowizja pośrednika (L) [%]", value: inp.commissionPct, onChange: function(v) { props.onChange("commissionPct", v); } }),
  ...
  return e("div", null,
    e("div", null,
      ...
      e("div", { className: "lk-grid lk-grid-2" },
        ...
        e(PctInput, { label: "Prowizja pośrednika (W) [%]", value: inp.commissionPct, onChange: function(v) { props.onChange("commissionPct", v); } }),
