    ...
    <aside className="hidden lg:flex flex-col w-64 h-screen bg-limona-surface border-r border-limona-border fixed left-0 top-0 z-40">
      ...
      <div className="p-6 border-b border-limona-border">
        <Link href="/dashboard" className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-heading font-bold text-lg uppercase tracking-wide text-limona-white leading-none">
              Limona
            </h1>
            <span className="text-[10px] uppercase tracking-[0.2em] text-limona-text-muted">
              CRM
            </span>
          </div>
        </Link>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-limona-lime/10 text-limona-lime border-l-2 border-limona-lime'
